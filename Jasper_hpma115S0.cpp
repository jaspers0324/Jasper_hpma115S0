 ...
 * @return  void
 */
Jasper_HPMA115S0::Jasper_HPMA115S0(Stream& serial):
  _serial(serial)
{
 ...
 * @return  void
 */
void Jasper_HPMA115S0::SendCmd(unsigned char * cmdBuf, unsigned int cmdSize) {
  //Clear RX
 ...
 */
int Jasper_HPMA115S0::ReadCmdResp(unsigned char * dataBuf, unsigned int dataBufSize, unsigned int cmdType) {
 ...
 */
boolean Jasper_HPMA115S0::ReadParticleMeasurement(unsigned int * pm2_5, unsigned int * pm10) {
  unsigned char cmdBuf[] = {0x68, 0x01, 0x04, 0x93}; // instead const to unsigned
 ...
 * @return  void
 */
void Jasper_HPMA115S0::StartParticleMeasurement() {
  unsigned char cmd[] = {0x68, 0x01, 0x01, 0x96}; // instead const to unsigned
  SendCmd(cmd, 4);
}
 ...
 * @return  void
 */
void Jasper_HPMA115S0::StopParticleMeasurement() {
  unsigned char cmd[] = {0x68, 0x01, 0x02, 0x95}; // instead const to unsigned
  SendCmd(cmd, 4);
}
 ...
 * @return  void
 */
void Jasper_HPMA115S0::EnableAutoSend() {
  unsigned char cmd[] = {0x68, 0x01, 0x40, 0x57}; // instead const to unsigned
  SendCmd(cmd, 4);
}
 ...
 * @return  void
 */
void Jasper_HPMA115S0::DisableAutoSend() {
  unsigned char cmd[] = {0x68, 0x01, 0x20, 0x77}; // instead const to unsigned
  SendCmd(cmd, 4);
}
...
*/
unsigned int Jasper_HPMA115S0::GetPM2_5() {
  return _pm2_5;
}
...
*/
unsigned int Jasper_HPMA115S0::GetPM10() {
  return _pm10;
}